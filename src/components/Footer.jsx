            ...
            {SOCIAL_LINKS.map((link) => (
              <li key={link.name}>
                <a
                  ...
                  className="block text-text-muted hover:text-[#ffbf00] hover:scale-110 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-bg-main rounded"
                  aria-label={`Visit ${link.name} profile`}
                >
                  {ICON_MAP[link.platform] || null}
                </a>
              </li>
            ))}
          </ul>
